...
1. **Swagger UI**: Truy cập `https://ten-app-cua-ban.onrender.com/api`
2. **Sentry**: Nếu bạn cấu hình `SENTRY_DSN`, mọi lỗi trên server sẽ được báo về email ngay lập tức.
